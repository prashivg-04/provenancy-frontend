                ...
                {dummyTableData.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6 text-right">
                      <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold border border-primary/20 bg-primary/10 text-primary uppercase tracking-widest">
                        {row.status}
                      </span>
                    </td>
                  </tr>
